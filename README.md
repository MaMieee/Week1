...
If you are on GitHub, following the link you got, there is the name of the repositiory at the top, below that there is a tool-bar (Code, Issues, Pull requests, Actions, ...), and below that some buttons. Clicking on the green "Use this template" button is one way of creating your own repository from the template.
